...
What worked instead was a supervised classifier, logistic regression, five-fold cross-validated, standardized only within each training fold, on the same ten features. It reaches 87.6\% accuracy (Wilson 95\% CI 80.8--92.2\%) telling clean from damaged. Fig.~\ref{fig:external_mosaic} shows three examples: clean called clean at 0.999, an impact crack called damaged at 0.997, and a genuine miss, a dust-streaked panel Sunnybotics labels \emph{damaged}, called clean at 0.542, essentially a coin flip. I read that last case as informative, not embarrassing: it suggests the damage label covers soiling as well as breakage, a detail I would not have found without looking at the actual photo.
